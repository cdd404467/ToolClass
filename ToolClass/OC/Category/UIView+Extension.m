...
static void *viewTypeKey = &viewTypeKey;
- (NSInteger)viewType {
    return [objc_getAssociatedObject(self, &viewTypeKey) integerValue];
}

- (void)setViewType:(NSInteger)viewType {
    objc_setAssociatedObject(self, &viewTypeKey, @(viewType), OBJC_ASSOCIATION_ASSIGN);
}

static void *viewIdKey = &viewIdKey;
- (NSString *)viewId {
    return objc_getAssociatedObject(self, &viewIdKey);
}

- (void)setViewId:(NSString *)viewId {
    objc_setAssociatedObject(self, &viewIdKey, viewId, OBJC_ASSOCIATION_COPY);
}
@end
